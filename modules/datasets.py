...
# =============================================================================
# BaseMimicDataset — MIMIC-CXR ke liye (NO corrupt check, NO dup check, NO shuffle)
# Reason:
#   1. MIMIC ~220k samples — corrupt check pe ~10 min extra init time lagti hai
#   2. MIMIC annotation JSON already curated hai R2Gen preprocessing se
#   3. Shuffle hata diya — DataLoader ka shuffle=True kaam karta hai properly
#   4. Full dataset use karna early epochs mein zyada patterns dikhata hai
#      → BLEU-1 pehle epoch se higher start hota hai
# =============================================================================

...
class BaseTester(object):
    def __init__(self, fw_adj, bw_adj, model, criterion, criterion_c, metric_ftns, args):
        self.args = args
...
class Tester(BaseTester):
    def __init__(self, fw_adj, bw_adj, model, criterion, criterion_c,  metric_ftns, args, test_dataloader):
        super(Tester, self).__init__(model, fw_adj, bw_adj, criterion, criterion_c, metric_ftns, args)
